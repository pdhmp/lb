...
namespace CyrnelSync
{
    public partial class frmCyrnelSync : Form
    {
        ...
        private void ServerLogin()
        {
            ...
            AppSendKeys("Cyrnel Hub Platform Login", "luis.fonseca@nestinvestimentos.com.br");
            AppSendKeys("Cyrnel Hub Platform Login", "{TAB}{TAB}{TAB}{TAB}{TAB}");
            AppSendKeys("Cyrnel Hub Platform Login", "nest1234");
            AppSendKeys("Cyrnel Hub Platform Login", "{TAB}");
            Thread.Sleep(100);
            AppSendKeys("Cyrnel Hub Platform Login", "{TAB}");
            Thread.Sleep(100);
            AppSendKeys("Cyrnel Hub Platform Login", "{TAB}");
