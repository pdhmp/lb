...
namespace MyRTD
{
    ...
    class Program
    {
        ...
        private const String RTDProgID = "Nest.Rtd";
        private const String RTDUpdateEventProgID = "m_callback";
        private const String RTDEXEProgID = "Nest.Rtd";
        private const String RTDEXEUpdateEventProgID = "Nest.Rtd";

        // Dummy topic. 
        private const int topicID = 12345;
        private const String topic = "PETR4";
