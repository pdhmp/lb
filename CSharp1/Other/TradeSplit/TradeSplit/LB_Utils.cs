        ...
        public void SetColumnStyle(DevExpress.XtraGrid.Views.Grid.GridView GridName, int Type_Grid, string Coluna)
        {
            ...
            try
            {
                ...
                using (newNestConn curConn = new newNestConn())
                {
                    ...
                    SQLString = "Select * from UI_DEFS.dbo.Tb211_Grid_Columns (nolock) where IdGrid =" + IdGrid + " and IdUser =" + NestDLL.NUserControl.Instance.User_Id + " order by GroupIndex ASC, VisibleIndex ASC";
...
//                            Caption = curRow["Caption_Coluna"].ToString();
            ...
            using (newNestConn curConn = new newNestConn())
            {
                ...
                foreach (DevExpress.XtraGrid.Columns.GridColumn coluna in Nome_Grid.Columns)
                {
                    ...
                    if (Nome != "Edit" && Nome != "Cancel" && Nome != "")
                    {
                       ...
                       " VALUES (" + Id_Grid + "," + NestDLL.NUserControl.Instance.User_Id + ",'" + Nome + "'," + largura + "," + visivel + "," + indice + "," + indice_grupo + ")";
        ...
        public void Set_Controls_Form(Form Formulario)
        {
            ...
            using (old_Conn curConn = new old_Conn())
            {
                ...
                SQLString = "SELECT * from UI_DEFS.dbo.Tb201_Form_Properties (nolock) WHERE Id_Form=" + Id_Form + " AND Id_User=" + NestDLL.NUserControl.Instance.User_Id;
