...
namespace SGN
{
    ...
    // ======================  Load Combo boxes =========================================================
            ...
            CargaDados.carregacombo(this.cmbChoosePortfolio, "Select Id_Portfolio,Port_Name, Id_Port_Type from  dbo.Tb002_Portfolios where Discountinued<>1 and Id_Port_Type=1 UNION ALL SELECT '-1', 'All Portfolios', '0' ORDER BY Id_Port_Type DESC,Port_Name", "Id_Portfolio", "Port_Name", 99);
            ...
            cmbCustomView.Items.Add("Ops Report");
    ...
    // ======================  Set initial values for all controls =========================================================
        ...
        private void tmrRefreshPos_Tick(object sender, EventArgs e)
        {
            ...
            if (!ThreadRunning && !bolHoldCalc)
            {
                ...
                {
                    selRow = (int)dgPositions.GetSelectedRows()[0];
        ...
        void UpdateGrid()
        {
            ...
            try
            {
                ...
                {
                    String_Campos = String_Campos.Replace("WHERE", "WHERE ([Id Instrument]=3 OR [Id Base Underlying] IN (SELECT [Id Base Underlying] FROM " + Temp_Table_Name + " WHERE [Id Instrument]=3 AND [Id Portfolio] =" + IdPortfolio + ")) AND ");
                }
                ...
                foreach (DataRow row in tablep.Rows)
                {
                    if (Valida.IsNumeric(srcList[0].ToString()))
                    {
              ...
              */
                ...
                while (contador >= 0)
                {
                    ...
                    int retorno = Convert.ToInt32(CargaDados.curConn.Execute_Query_String(SQLString));
        ...
        void SetValue(object data, int row, int column, object val)
         ...
         private void ApplyCustomColumns()
         {
             if (cmbCustomView.SelectedItem != null)
             {
                 ...
                 {
                     Valida.SetColumnStyle(dgPositions, 1);
                 }

                 if (cmbCustomView.SelectedItem.ToString() == "Ops Report")
                 {
                     StdOpsReport();
                 }
        ...
        void StdOpsReport()
        {
            ...
            dgPositions.Columns["Column4"].VisibleIndex = 0;
            dgPositions.Columns["Column15"].VisibleIndex = 1;
            dgPositions.Columns["Column111"].VisibleIndex = 2;
            dgPositions.Columns["Column28"].VisibleIndex = 3;
            dgPositions.Columns["Column16"].VisibleIndex = 4;
            dgPositions.Columns["Column14"].VisibleIndex = 5;
            dgPositions.Columns["Column117"].VisibleIndex = 6;
            dgPositions.Columns["Column20"].VisibleIndex = 7;
            dgPositions.Columns["Column109"].VisibleIndex = 8;
            dgPositions.Columns["Column112"].VisibleIndex = 9;
          //new DevExpress.XtraGrid.Columns.GridColumnSortInfo(this.colCountry, DevExpress.Data.ColumnSortOrder.Ascending)});
            ...
            dgPositions.Columns["Column33"].VisibleIndex = 10; //Instrument
            dgPositions.Columns["Column30"].VisibleIndex = 11; //Underlying Country
            dgPositions.Columns["Column156"].VisibleIndex = 12; //[Asset PL uC Admin]
...
//            dgPositions.Columns["Column9"].VisibleIndex = 8; //Strategy
        ...
        void FormatAllColumns()
        {
            ...
            dgPositions.Columns[81].DisplayFormat.FormatString = "#,##0.0000;(#,##0.0000)";

            dgPositions.Columns[82].DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
            dgPositions.Columns[82].DisplayFormat.FormatString = "#,##0.0000;(#,##0.0000)";
            ...
            dgPositions.Columns[84].DisplayFormat.FormatString = "#,##0.0000;(#,##0.0000)";
            ...
            dgPositions.Columns[86].DisplayFormat.FormatString = "#,##0.0000;(#,##0.0000)";

            dgPositions.Columns[87].DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
            dgPositions.Columns[87].DisplayFormat.FormatString = "#,##0.0000;(#,##0.0000)";

            dgPositions.Columns[88].DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
            dgPositions.Columns[88].DisplayFormat.FormatString = "#,##0.0000;(#,##0.0000)";

            dgPositions.Columns[89].DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
            dgPositions.Columns[89].DisplayFormat.FormatString = "#,##0.0000;(#,##0.0000)";
            ...
            dgPositions.Columns[106].DisplayFormat.FormatString = "#,##0;(#,##0)";
            ...
            dgPositions.Columns[186].DisplayFormat.FormatString = "#,##0;(#,##0)";
        ...
        {
            if (cmbCustomView.SelectedItem.ToString() == "Custom") { Valida.Save_Columns(dgPositions); }
        }
        ...
        private void radRealTime_CheckedChanged(object sender, EventArgs e)
        {
            if (radRealTime.Checked == true)
            {
                ...
                CargaDados.carregacombo(this.cmbChoosePortfolio, "Select Id_Portfolio,Port_Name, Id_Port_Type from  dbo.Tb002_Portfolios where Id_Port_Type=2 and RT_Position=1 UNION ALL SELECT '-1', 'All Portfolios', '0' ORDER BY Id_Port_Type DESC,Port_Name", "Id_Portfolio", "Port_Name", tempPortfolio);
                ...
                chkLinkAllBoxes.BackColor = Color.FromArgb(77, 117, 170);
        ...
        private void radHistoric_CheckedChanged(object sender, EventArgs e)
        {
            if (radHistoric.Checked == true)
            {
                ...
                CargaDados.carregacombo(this.cmbChoosePortfolio, "Select Id_Portfolio,Port_Name, Id_Port_Type from  dbo.Tb002_Portfolios where Discountinued<>1 and Id_Port_Type in (1,2) UNION ALL SELECT '-1', 'All Portfolios', '0' ORDER BY Id_Port_Type DESC,Port_Name", "Id_Portfolio", "Port_Name", tempPortfolio);

                dtpHistDate.Value =DateTime.Now.AddDays(-1);
                tmrRefreshPos.Stop();
                prevTable = posTableName;
                ...
                tmrRefreshPos.Start();
                dtg.LookAndFeel.SetSkinStyle("The Asphalt World");
        ...
        private void Add_Totals()
        {
            ...
            dgPositions.GroupSummary.Add(SummaryItemType.Sum, "Column73", dgPositions.Columns["Column73"], "{0:#,#0}");
            ...
            dgPositions.GroupSummary.Add(SummaryItemType.Sum, "Column112", dgPositions.Columns["Column112"], "{0:#,#0}");
            dgPositions.GroupSummary.Add(SummaryItemType.Sum, "Column113", dgPositions.Columns["Column113"], "{0:#,#0}");
            dgPositions.GroupSummary.Add(SummaryItemType.Sum, "Column114", dgPositions.Columns["Column114"], "{0:#,#0}");
            ...
            dgPositions.GroupSummary.Add(SummaryItemType.Sum, "Column86", dgPositions.Columns["Column86"], "{0:#,#0.0000}");
            dgPositions.GroupSummary.Add(SummaryItemType.Sum, "Column87", dgPositions.Columns["Column87"], "{0:#,#0.0000}");
            dgPositions.GroupSummary.Add(SummaryItemType.Sum, "Column88", dgPositions.Columns["Column88"], "{0:#,#0.0000}");
            dgPositions.GroupSummary.Add(SummaryItemType.Sum, "Column89", dgPositions.Columns["Column89"], "{0:#,#0.0000}");
        ...
        private void dgPositions_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            if (this.dgPositions.GetFocusedRowCellValue("Column0") != null)
            {
                ...
                this.Carrega_Dados(Id_Position, Id_Ticker,posTableName);
                this.Carrega_Trades_Pos(Id_Position,posTableName);
                base.Focus();
            }
        }
        ...
        {
            Point pt = dtg.PointToClient(MousePosition);
            ...
            if (hi.InRow && hi.Column != null)
            {
                if(hi.Column.Name == "colColumn4")
                {
                    ...
                    {
                        CargaDados.curConn.ExecuteNonQuery("UPDATE NESTRT.dbo.Tb000_Posicao_Atual SET [Calc Error Flag]=2 WHERE [Id Position]=" + Id_Position);
                        CargaDados.curConn.ExecuteNonQuery("EXEC NESTDB.dbo.PROC_GET_CALCULATE_COST_CLOSE " + Id_Position );
                        CargaDados.curConn.ExecuteNonQuery("EXEC NESTDB.dbo.PROC_GET_CALCULATE_FIELDS_HIST " + Id_Position + ", 0");
                    }
                }
            }
        }
