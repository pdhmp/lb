...
namespace LiveBook
{
    public partial class frmRebateClients : LBForm
    {
        ...
        private void frmRebateClients_Load(object sender, EventArgs e)
        {
            ...
            NestDLL.FormUtils.LoadCombo(this.CmbDate, "Select distinct(RefDate) as RefDate FROM NESTIMPORT.dbo.Tb_Mellon_Investors_Perf order by RefDate ", "RefDate", "RefDate", 99);
        ...
        private void cmdExcel_Click(object sender, EventArgs e)
        {
            ...
            if (fileName != "")
            {
                ...
                string fileName_Log = "T:\\Log\\Reports\\Position_Id_LB_" + NestDLL.NUserControl.Instance.User_Id + "_Id_AD_" + user + "_Computer_" + Loca_Machine + "_Rebate_Date_" + DateTime.Now.ToString("yyyyMMdd_HH-mm-ss") + ".xls";
