...
namespace NCalculatorDLL
{
    public class PositionItem : IComparable
    {
        ...
        public void SetCostData()//PROC_GET_CALCULATE_COST_CLOSE and [FCN_Cost_Close]
        {
            ...
            if (this.IdSecurity == 305 || this.IdSecurity == 306)
            {
                if (this.QuantBoughtCf != 0) { this.AvgPriceBought = (this.AmtBoughtCf * this.LotSize) / this.QuantBoughtCf; }
                if (this.QuantSoldCf != 0) { this.AvgPriceSold = (this.AmtSoldCf * this.LotSize) / this.QuantSoldCf; }
            }
            else
            {
            ...
            if (this.IdSecurity == 305 || this.IdSecurity == 306)
            {
                this.Realized = (QuantRealized * (AvgpRealized - this.CostClose)) + this.Dividends;
                this.RealizedAdmin = (QuantRealized * (AvgpRealizedAdmin - this.CostCloseAdmin)) + this.Dividends;
            }
            else
            {
