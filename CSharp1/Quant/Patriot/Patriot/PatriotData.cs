    ...
    public class PatriotData
    {
        ...
        public void InitializeObjects()
        {
            if (!isInitialized && iniDateInitialized)
            {
                ...
                CloseAucAvg5d = new FastData(315, _IniDate, DateTime.Now, 22);
                //TODO: CloseAucAvg5d = new FastData(313, _IniDate, DateTime.Now, 22);
                Last30Avg5d = new FastData(333, _IniDate, DateTime.Now, 22);
                //TODO: Last30Avg5d = new FastData(332, _IniDate, DateTime.Now, 22);
                First330Vwap = new FastData(351, _IniDate, DateTime.Now, 22);
                First330Volume = new FastData(350, _IniDate, DateTime.Now, 22);
                //TODO: First330Avg5d = new FastData(352, _IniDate, DateTime.Now, 22);
                First330Avg5d = new FastData(353, _IniDate, DateTime.Now, 22);
