...
namespace QuickNestFIX
{
    ...
    /// </summary>
    public class DropCopy: MessageCracker, QuickFix.Application
    {
        private SessionType _sessionType = SessionType.DropCopy;
        ...
        public DropCopy()
        {
            string strConfigPath = QuickNestFIX.Properties.Settings.Default.DropCopyConfigPath;
