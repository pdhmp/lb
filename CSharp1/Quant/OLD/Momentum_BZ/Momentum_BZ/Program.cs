...
namespace NestQuant.NestSim
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            Sector_Momentum_BZ_Container MomentumBZ_Container = new Sector_Momentum_BZ_Container(false);
            MomentumBZ_Container.iniDate = iniDate;
            MomentumBZ_Container.endDate = endDate;
            MomentumBZ_Container.Id_Ticker_Template = 1073;
            MomentumBZ_Container.Name = "Momentum_BZ";
