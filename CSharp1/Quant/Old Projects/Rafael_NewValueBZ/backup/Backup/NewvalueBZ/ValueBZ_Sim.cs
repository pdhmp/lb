...
namespace NewValueBZ
{
    class ValueBZ_Sim
    {
        ...
        public ValueBZ_Sim()
        {
            ...
            {
                //string SQLString = "SELECT Data_Hora_Reg FROM NESTDB.dbo.Tb053_Precos_Indices WHERE Data_Hora_Reg='2010-03-25' AND Id_Ativo=1073 AND Tipo_Preco=1 AND Source=1 ORDER BY Data_Hora_Reg DESC";
                string SQLString = "SELECT TOP 50 Data_Hora_Reg FROM NESTDB.dbo.Tb053_Precos_Indices WHERE Id_Ativo=1073 AND Tipo_Preco=1 AND Source=1 ORDER BY Data_Hora_Reg DESC";
                ...
                {
                    DateTime curDate = DateTime.Parse(curRow["Data_Hora_Reg"].ToString());
                    LoadForDate(curDate);
        ...
        public class StatItem
        {
            ...
            public void CalcStats()
            {
                ...
                {
                    //double curValue = curValueItem.Weight / StratPositions.Count * curValueItem.curSignal;
