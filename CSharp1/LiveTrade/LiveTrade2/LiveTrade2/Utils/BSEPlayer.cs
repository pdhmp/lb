    ...
    class BSEPlayer
    {
        ...
        private void SendData(object sender, EventArgs e)
        {
            ...
            switch (DataArgs.FLID)
            {
                ...
                case NestFLIDS.FullBidBroker1:
                case NestFLIDS.FullBidBroker2:
                case NestFLIDS.FullBidBroker3:
                case NestFLIDS.FullBidBroker4:
                case NestFLIDS.FullBidBroker5:
                case NestFLIDS.FullBidBroker6:
                case NestFLIDS.FullBidBroker7:
                case NestFLIDS.FullBidBroker8:
                case NestFLIDS.FullBidBroker9:
                case NestFLIDS.FullBidBroker10:
                case NestFLIDS.FullBidBroker11:
                case NestFLIDS.FullBidBroker12:                
                case NestFLIDS.FullAskBroker1:
                case NestFLIDS.FullAskBroker2:
                case NestFLIDS.FullAskBroker3:
                case NestFLIDS.FullAskBroker4:
                case NestFLIDS.FullAskBroker5:
                case NestFLIDS.FullAskBroker6:
                case NestFLIDS.FullAskBroker7:
                case NestFLIDS.FullAskBroker8:
                case NestFLIDS.FullAskBroker9:
                case NestFLIDS.FullAskBroker10:
                case NestFLIDS.FullAskBroker11:
                case NestFLIDS.FullAskBroker12:
                case NestFLIDS.Description:
                case NestFLIDS.Exchange:
                case NestFLIDS.None:
                    DataArgs.ValueString = DataArgs.ValueString; 
                    break;
                case NestFLIDS.TradingStatus:
                default:
                    DataArgs.ValueDouble = double.Parse(DataArgs.ValueString.Replace(".",",")); 
                    break;
            }
