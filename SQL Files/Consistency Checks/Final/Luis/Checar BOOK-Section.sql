...
ORDER BY ABS(convert(numeric,coalesce(Quant_Final,0))-convert(numeric,coalesce(Quant_Trades,0))-convert(numeric,coalesce(Quant_Initial,0))) DESC, Simbolo
