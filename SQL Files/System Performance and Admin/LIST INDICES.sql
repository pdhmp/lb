...
select o.name  AS cTableName,
  ...
  'index column 2' = index_col(o.name,indid, 3),
  'index column 2' = index_col(o.name,indid, 4),
  'index column 2' = index_col(o.name,indid, 5),
  'index column 2' = index_col(o.name,indid, 6),
  'index column 2' = index_col(o.name,indid, 7),
  'index column 2' = index_col(o.name,indid, 8)
