    ...
    class LB_HTML
    {
        ...
        public string Risk_Summary(int Id_Portfolio, bool InternalOnly)
        {
            using (newNestConn curConn = new newNestConn())
            {
                ...
                string SQLString = "SELECT * FROM dbo.[FCN_Risk_Limits]() WHERE Id_Portfolio not in (-10,4,60,43) ORDER BY Id_Portfolio, Valid_As_Of, Id_Risk_Limit_Group, Risk_Limit_Type";
        ...
        string FowardsArb(int IdPortfolio, DateTime ReportDate)
        {
            ...
            string StringSQL = "Select SUM(FWValue)/max(NAV) from " + Table_Name + " where [Id Portfolio]=38 and [Date now]='" + ReportDate.ToString("yyyyMMdd") + "' AND [FWD Adj P/L]<>0";
        ...
        string OptionsLoss(int IdPortfolio, DateTime ReportDate)
        {
            ...
            StringSQL += " AND [Date Now]='" + ReportDate.ToString("yyyyMMdd") + "' AND [Option Type]=0 AND [Id Instrument]=3  " +
                         " ) A " +
                         " ) B       " +
                         "GROUP BY Underlying      ";
        ...
        string OptionsLoss_old(int IdPortfolio, DateTime ReportDate)
        {
        ...
        public string Illiquid_Stocks()
        {
            ...
            tempHTML = tempHTML + "<div style='color=#FF9900;font-family:Tahoma; font-size=2pt;'>&nbsp;</div>";
            tempHTML = tempHTML + "<div style='color=#FF9900;font-family:Tahoma; font-size=12pt; font-weight:bold'>Illiquid Stocks</div>";
            tempHTML = tempHTML + "<div style='color=#FF9900;font-family:Tahoma; font-size=2pt;'>&nbsp;</div>";
            ...
            tempHTML = tempHTML + "<tr style='background-color: #999999; color=white; font-size=8pt; font-family:Tahoma; font-weight:bold'>" +
                                        "<td align=center width=60>Ticker</td>" +
                                        "<td align=center width=60>Position</td>" +
                                        "<td align=center width=60>Average Volume</td>" +
                                        "<td align=center width=60>Last</td>" +
                                        "<td align=center width=60>$ Average Volume</td>" +
                                        "<td align=center width=60>Total Amount</td>" +
                                        "<td align=center width=60>Bought</td>" +

                                    "</tr>";

            SQLString = "SELECT NestTicker AS Ticker, Position, AvVolume AS 'Average Volume', Last, FinAvVolume AS '$ Average Volume', TotalAmt AS 'Total Amount', Bought FROM [NESTDB].[dbo].[FCN_Risk_Illiquid_Stocks]();";
            ...
            foreach (DataRow curRow in tablep.Rows)
            {
                ...
                tempHTML = tempHTML + "<td align=right style='font-family:Tahoma; font-size=8pt'>";
                tempHTML = tempHTML + curRow["Position"];
                tempHTML = tempHTML + "</td>";

                tempHTML = tempHTML + "<td align=right style='font-family:Tahoma; font-size=8pt'>";
                tempHTML = tempHTML + curRow["Average Volume"];
                tempHTML = tempHTML + "</td>";

                tempHTML = tempHTML + "<td align=right style='font-family:Tahoma; font-size=8pt'>";
                tempHTML = tempHTML + curRow["Last"];
                tempHTML = tempHTML + "</td>";
                ...
                tempHTML = tempHTML + "<td align=right style='font-family:Tahoma; font-size=8pt'>";
                tempHTML = tempHTML + curRow["Total Amount"];
                tempHTML = tempHTML + "</td>";

                tempHTML = tempHTML + "<td align=right style='font-family:Tahoma; font-size=8pt'>";
                tempHTML = tempHTML + curRow["Bought"];
                tempHTML = tempHTML + "</td>";
        ...
        public string Contact_Sub_Summary(int Id_Contact)
        {
            ...
            using (newNestConn curConn = new newNestConn())
            {
                string SQLString = "SELECT * FROM (SELECT 'MH' AS Fund, * FROM dbo.FCN_COM_ContactSubSummary(" + Id_Contact.ToString() + ", 2, 0) " +
                                ...
                                "UNION SELECT 'ARB 30' AS Fund, * FROM dbo.FCN_COM_ContactSubSummary(" + Id_Contact.ToString() + ", 62, 0)" +
                                "UNION SELECT 'Nest Previdencia' AS Fund, * FROM dbo.FCN_COM_ContactSubSummary(" + Id_Contact.ToString() + ", 50, 0)" +
        ...
        public string Contact_Red_Summary(int Id_Contact, bool IncludeIR)
        {
            ...
            using (newNestConn curConn = new newNestConn())
            {
                string SQLString = "SELECT *, alocQuantity*redNAV AS redAmount FROM ( " +
                                ...
                                "UNION SELECT 'ARB 30' AS Fund, * FROM dbo.FCN_COM_ContactRedSummary(" + Id_Contact.ToString() + ", 62, 0)" +
                                "UNION SELECT 'Nest Previdencia' AS Fund, * FROM dbo.FCN_COM_ContactRedSummary(" + Id_Contact.ToString() + ", 50, 0)" +
                ...
                foreach (DataRow curRow in tablep.Rows)
                {
                    ...
                    tempHTML = tempHTML + "<td align=right style='font-family:Tahoma; font-size=8pt" + topRow + "'>";
                    tempHTML = tempHTML + ifStrNull(GlobalVars.Instance.TryParse_Double(curRow["origQuantity"]) * GlobalVars.Instance.TryParse_Double(curRow["subNAV"]), "#,##0.00");
                    tempHTML = tempHTML + "</td>";
                    ...
                    tempHTML = tempHTML + "<td align=right style='font-family:Tahoma; font-size=8pt" + topRow + "'>";
                    tempHTML = tempHTML + ifStrNull(GlobalVars.Instance.TryParse_Double(curRow["noDays"]) / 30.42, "#,##0.0");
                    tempHTML = tempHTML + "</td>";
                    ...
                    double perFund = 0;
                    perFund = GlobalVars.Instance.TryParse_Double(curRow["PerfFund"]);
                    
                    double perBench = 0;
                    perBench = GlobalVars.Instance.TryParse_Double(curRow["PerfBench"]);
                    ...
                    FundSubCost += GlobalVars.Instance.TryParse_Double(curRow["origQuantity"]) * Convert.ToDouble(curRow["subNAV"]);
                    FundSubValue += GlobalVars.Instance.TryParse_Double(curRow["redAmount"]);

                    TotalSubCost += GlobalVars.Instance.TryParse_Double(curRow["origQuantity"]) * Convert.ToDouble(curRow["subNAV"]); ;
                    TotalSubValue += GlobalVars.Instance.TryParse_Double(curRow["redAmount"]);
                ...
                if (tablep.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow curRow in tablep.Rows)
                    {
                        ...
                        foreach (DataColumn curColumn in tablep.Columns)
                        {
                            ...
                            {
                                tempHTML = tempHTML + LiveDLL.Utils.ParseToDateTime(curRow[curColumn]).ToString("dd-MMM-yy");
                            }
                            else
                            {
            ...
            using (newNestConn curConn = new newNestConn())
            {
                ...
                foreach (DataRow curRow in tablep.Rows)
                {
                    if (curRow["Portfolio"].ToString() != Portfolio)
                    {
                        ...
                        tempHTML = tempHTML + "<td align=left width=10 style='font-family:Tahoma; font-size=8pt'>" + LiveDLL.Utils.ParseToDouble(curRow["TotalLines"]).ToString("0") + "</td>";
                        tempHTML = tempHTML + "<td align=left width=80 style='font-family:Tahoma; font-size=8pt;'>Total Securities</td>";
                        tempHTML = tempHTML + "<td align=left width=10 style='font-family:Tahoma; font-size=8pt'>" + LiveDLL.Utils.ParseToDouble(curRow["TotalSecurities"]).ToString("0") + "</td>";
                        tempHTML = tempHTML + "</tr>";
                        ...
                        tempHTML = tempHTML + "<td align=right style='font-family:Tahoma; font-size=8pt'>" + LiveDLL.Utils.ParseToDouble(curRow["Longs"]).ToString("0") + "</td>";
                        tempHTML = tempHTML + "<td align=right style='font-family:Tahoma; font-size=8pt'>" + LiveDLL.Utils.ParseToDouble(curRow["Shorts"]).ToString("0") + "</td>";
                        tempHTML = tempHTML + "<td></td>";
                        tempHTML = tempHTML + "</tr>";

                        tempHTML = tempHTML + "<tr>";
                        tempHTML = tempHTML + "<td align=right style='font-family:Tahoma; font-size=8pt; font-weight:bold'>Total </td>";
                        tempHTML = tempHTML + "<td align=right style='font-family:Tahoma; font-size=8pt'>" + LiveDLL.Utils.ParseToDouble(curRow["TotalLong"]).ToString("0.00%") + "</td>";
                        tempHTML = tempHTML + "<td align=right style='font-family:Tahoma; font-size=8pt'>" + LiveDLL.Utils.ParseToDouble(curRow["TotalShort"]).ToString("0.00%") + "</td>";
                        tempHTML = tempHTML + "<td></td>";
                        tempHTML = tempHTML + "</tr>";

                        tempHTML = tempHTML + "<tr>";
                        tempHTML = tempHTML + "<td align=right style='font-family:Tahoma; font-size=8pt; font-weight:bold'>Top 20 </td>";
                        tempHTML = tempHTML + "<td align=right style='font-family:Tahoma; font-size=8pt'>" + LiveDLL.Utils.ParseToDouble(curRow["Top20Long"]).ToString("0.00%") + "</td>";
                        tempHTML = tempHTML + "<td align=right style='font-family:Tahoma; font-size=8pt'>" + LiveDLL.Utils.ParseToDouble(curRow["Top20Short"]).ToString("0.00%") + "</td>";
                        tempHTML = tempHTML + "<td></td>";
                        tempHTML = tempHTML + "</tr>";

                        tempHTML = tempHTML + "<tr>";
                        tempHTML = tempHTML + "<td align=right style='font-family:Tahoma; font-size=8pt; font-weight:bold'>Top 5 </td>";
                        tempHTML = tempHTML + "<td align=right style='font-family:Tahoma; font-size=8pt'>" + LiveDLL.Utils.ParseToDouble(curRow["Top5Long"]).ToString("0.00%") + "</td>";
                        tempHTML = tempHTML + "<td align=right style='font-family:Tahoma; font-size=8pt'>" + LiveDLL.Utils.ParseToDouble(curRow["Top5Short"]).ToString("0.00%") + "</td>";
                        tempHTML = tempHTML + "<td></td>";
                        tempHTML = tempHTML + "</tr>";

                        tempHTML = tempHTML + "<tr>";
                        tempHTML = tempHTML + "<td align=right style='font-family:Tahoma; font-size=8pt; font-weight:bold'>Top 1 </td>";
                        tempHTML = tempHTML + "<td align=right style='font-family:Tahoma; font-size=8pt'>" + LiveDLL.Utils.ParseToDouble(curRow["Top1Long"]).ToString("0.00%") + "</td>";
                        tempHTML = tempHTML + "<td align=right style='font-family:Tahoma; font-size=8pt'>" + LiveDLL.Utils.ParseToDouble(curRow["Top1Short"]).ToString("0.00%") + "</td>";
                        tempHTML = tempHTML + "<td></td>";
                        tempHTML = tempHTML + "</tr>";
