...
namespace LiveBook
{
    public partial class frmEditBookSection : LBForm
    {
        ...
        private void frmEditStrategy_Load(object sender, EventArgs e)
        {
            ...
            LiveDLL.FormUtils.LoadCombo(this.cmbChoosePortfolio, "Select Id_Portfolio,Port_Name from  dbo.Tb002_Portfolios (nolock)  where Id_Port_Type =1 and Discountinued =0", "Id_Portfolio", "Port_Name", 1);
            ...
            LiveDLL.FormUtils.LoadCombo(this.cmbBook, "Select Id_Book, Book from Tb400_Books", "Id_Book", "Book", Id_Book);
        ...
        public void Carrega_Sub_Estrategy()
        {
            ...
            try
            {
                if (curUtils.IsNumeric(cmbBook.SelectedValue))
                {
                    ...
                    //SubEstrategia
                    LiveDLL.FormUtils.LoadCombo(this.cmbSection, "Select Id_Section,Sub_Strategy + ' - ' + Section as Section,Id_Book from dbo.VW_Book_Strategies WHERE Id_Book=" + valor + " ORDER BY Section", "Id_Section", "Section", Id_Section);
