...
namespace LiveBook
{
    public partial class frmUpdateStrategy : Form
    {
        ...
        {
                //SubEstrategia
            LiveDLL.FormUtils.LoadCombo(this.cmbSection, "Select Id_Section,Sub_Strategy + ' - ' + Section as Section,Id_Book from dbo.VW_Book_Strategies WHERE Id_Book=" + Id_Book + " ORDER BY Section", "Id_Section", "Section", Id_Section);
        }
