...
namespace LiveBook
{
    public partial class frmCheckBrokersTradesUsEquity : LBForm
    {
        DateTime FileDate;
        ...
        public frmCheckBrokersTradesUsEquity()
        {
            InitializeComponent();
        }
        ...
        public void Load_Grid_Trades()
        {
            using (newNestConn curConn = new newNestConn())
            {
                ...
                SQLString = "Select * FROM NESTIMPORT.dbo.FCN_Return_CheckQuantitiesBrokerUsEquity('" + dtpIniDate.Value.ToString("yyyyMMdd") + "') order by TradeDate,IdBroker,IdPortfolio,IdSecurity,TradeType";


                DataTable dtTrades = curConn.Return_DataTable(SQLString);

                dtgDiferencesBrokerFut.DataSource = dtTrades;
        ...
        private void frmCheckBrokersTradesUsEquity_Load(object sender, EventArgs e)
        {
