...
namespace LiveBook
{
    public partial class frmFowards : LBForm
    {
        ...
        {
            dtpIniDate.Value = DateTime.Today;
            dtpEndDate.Value = DateTime.Today.AddYears(2);
        ...
        private void Carrega_Grid()
        {
            ...
            SQLString = "SELECT * FROM NESTDB.dbo.[FCN_Return_Fowards]('" + dtpIniDate.Value.ToString("yyyyMMdd") + "','" + dtpEndDate.Value.ToString("yyyyMMdd") + "') WHERE Id_Portfolio=" + Id_Fund + " ORDER BY NestTicker ";
            ...
            dtgFoward.Columns["AvailableQuantity"].DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
            dtgFoward.Columns["AvailableQuantity"].DisplayFormat.FormatString = "#,##0;(#,##0)";

            dtgFoward.Columns["ClosedQuantity"].DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
            dtgFoward.Columns["ClosedQuantity"].DisplayFormat.FormatString = "#,##0;(#,##0)";

            dtgFoward.Columns["InitialQuantity"].DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
            dtgFoward.Columns["InitialQuantity"].DisplayFormat.FormatString = "#,##0;(#,##0)";
