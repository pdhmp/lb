...
namespace LiveBook
{
    public partial class frmOptionExerciseBroker : Form
    {
        ...
        {
            LiveDLL.FormUtils.LoadCombo(this.cmbBroker, "Select Id_Account,Nome from VW_Account_Broker Where Id_Portfolio = " + IdPortfolio + " order by Show_Prefered desc,Nome asc", "Id_Account", "Nome", getIdAccount());
        }
