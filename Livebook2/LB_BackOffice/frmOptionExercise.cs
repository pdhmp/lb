...
namespace LiveBook
{
    public partial class frmOptionExercise : LBForm
    {
        ...
        private void cmbFund_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            LiveDLL.FormUtils.LoadCombo(this.cmbExpiration, "SELECT Expiration, Expiration AS ExpDescription FROM NESTRT.dbo.Tb000_Posicao_Atual WHERE [Id Instrument]=3 AND [Id Portfolio]=" + IdPortolio + "GROUP BY Expiration", "Expiration", "ExpDescription", 99);


           // LiveDLL.FormUtils.LoadCombo(this.cmbExpiration, "SELECT Expiration, Expiration AS ExpDescription FROM NESTDB.dbo.Tb000_Historical_Positions WHERE [Id Instrument]=3 AND [Id Portfolio]=" + IdPortolio + " AND [Date now]='2011-11-21' GROUP BY Expiration", "Expiration", "ExpDescription", 99);
        ...
        void Load_Combos()
        {
            LiveDLL.FormUtils.LoadCombo(this.cmbFund, "Select Id_Portfolio,Port_Name from Tb002_Portfolios Where Id_Port_Type=2 and Discountinued=0 order by Port_Name", "Id_Portfolio", "Port_Name", 99);
