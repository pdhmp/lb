...
namespace LiveBook
{
    public partial class frmSubsRedemp : Form
    {
        ...
        void Load_Combos()
        {
            ...
            LiveDLL.FormUtils.LoadCombo(this.cmbTransType, "Select Id_Trans_Type, Description from dbo.Tb701_Transaction_Types WHERE Id_Trans_Type IN (30,31,32) order by Description", "Id_Trans_Type", "Description", 21);
        }
       ...
       private void cmdClose_Click(object sender, EventArgs e)
        ...
        private void Carrega_Grid()
        {
            ...
            curUtils.SetColumnStyle(dgSubRedemp, 1);
