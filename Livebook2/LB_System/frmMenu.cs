...
namespace LiveBook
{
    public partial class frmMenu : LBForm
    {
        ...
        public void FormOpener(Form FormToOpen)
        {
        ...
        public frmForwardReconciliation ForwardReconciliation;
        ...
        public frmRegistroOpas RegistroOpas;
        public frmFatosRelevantes FatoRelevante;
        public frmDecisoesColegiado DecisoesDoColegiado;
        ...
        public frmCheckBrokersTradesUsEquity OffShoreReconciliation;
        ...
        public frmIlliquidStocks IlliquidStocks;
        ...
        */
        ...
        void ChangeData_Portfolio(int Id_Portfolio, DateTime Historical)
        {
            if (Id_Portfolio != 0)
            {
                switch (Id_Portfolio)
                ...
                {
                    Top10Desc.Set_Portfolio_Values(Id_Portfolio);
                }
                if (Check_Open_Form("frmBottom10Contributions") != 0)
                {
                    Top10Asc.Set_Portfolio_Values(Id_Portfolio);
                }
                if (Check_Open_Form("frmTop10Long") != 0)
                {
                    Top10Long.Set_Portfolio_Values(Id_Portfolio);
                }
                if (Check_Open_Form("frmTop10Short") != 0)
                {
                    Top10Short.Set_Portfolio_Values(Id_Portfolio);
                }
                if (Check_Open_Form("frmTop10Changes") != 0)
                {
                    TopChanges.Set_Portfolio_Values(Id_Portfolio);
                }
                if (Check_Open_Form("frmBottom10Changes") != 0)
                {
                    BottonChanges.Set_Portfolio_Values(Id_Portfolio);
                }
                if (Check_Open_Form("frmSubPortfolio") != 0)
                {
                    SubPortfolioSummary.Set_Portfolio_Values(Id_Portfolio, Historical);
                }
                if (Check_Open_Form("frmExposure_PL") != 0)
                {
                    Tela_Exposure.Set_Portfolio_Values(Id_Portfolio);
                }
                if (Check_Open_Form("frmTradeSummary") != 0)
                {
                    Tela_TradeSummary.Set_Portfolio_Values(Id_Portfolio);
                }
                if (Check_Open_Form("frmOptionStrikes") != 0)
                {
                    OptionStrikes.Set_Portfolio_Values(Id_Portfolio);
                }
                if (Check_Open_Form("frmRiskMarginalVARs") != 0)
                {
                    MarginalVARs.Set_Portfolio_Values(Id_Portfolio);
                }
                ...
                {
                    RiskOptions.Set_Portfolio_Values(Id_Portfolio);
                }
                if (Check_Open_Form("frmRiskSectors") != 0)
                {
                    RiskSectors.Set_Portfolio_Values(Id_Portfolio);
                }
                if (Check_Open_Form("frmBookPerfSummary") != 0)
                {
                    BookPerfSummary.Set_Portfolio_Values(Id_Portfolio);
                }
            }
        }
        ...
        */
        ...
        public void Carrega_Form()
        {
            ...
            SQLString = "SELECT A.*, B.* " +
                        ...
                        "WHERE Id_User=" + LiveDLL.NUserControl.Instance.User_Id + " and Visible = 1 AND IdApplication=1" +
            ...
            using (newNestConn curConn = new newNestConn())
            {
                ...
                foreach (DataRow curRow in curTable.Rows)
                {
                    ...
                    switch (curRow["Form_Name"].ToString())
                    {
                        ...
                        case "frmForwardReconciliation": fowardToolStripMenuItem_Click(this, new EventArgs()); break;
                        ...
                        case "frmPositionSummary": positionSummaryToolStripMenuItem_Click(this, new EventArgs()); break;
                        ...
                        case "frmRegistroOpas": opasAlertToolStripMenuItem_Click(this, new EventArgs()); break;
                        case "frmFatosRelevantes": fatoRelevanteToolStripMenuItem_Click(this, new EventArgs()); break;
                        case "frmDecisoesColegiado": decisoesDoColegiadoToolStripMenuItem_Click(this, new EventArgs()); break;
        ...
        private void offShoreReconciliationToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (OffShoreReconciliation == null || OffShoreReconciliation.IsDisposed)
            {
                OffShoreReconciliation = new frmCheckBrokersTradesUsEquity();
                FormOpener(OffShoreReconciliation);
            }
        }
        ...
        private void illiquidStocksToolStripMenuItem_Click(object sender, EventArgs e)
        {
            IlliquidStocks = new frmIlliquidStocks();
            FormOpener(IlliquidStocks);
        }
        ...
        {
            if (ForwardReconciliation == null || ForwardReconciliation.IsDisposed)
            {
                ForwardReconciliation = new frmForwardReconciliation();
                FormOpener(ForwardReconciliation);
            }
        }

        private void opasAlertToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (RegistroOpas == null || RegistroOpas.IsDisposed)
            {
                RegistroOpas = new frmRegistroOpas();
                FormOpener(RegistroOpas);
            }
        }

        private void fatoRelevanteToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (FatoRelevante == null || FatoRelevante.IsDisposed)
            {
                FatoRelevante = new frmFatosRelevantes();
                FormOpener(FatoRelevante);
            }
        }

        private void decisoesDoColegiadoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (DecisoesDoColegiado == null || DecisoesDoColegiado.IsDisposed)
            {
                DecisoesDoColegiado = new frmDecisoesColegiado();
                FormOpener(DecisoesDoColegiado);
            }
        }
        ...
        private void marginToolStripMenuItem2_Click(object sender, EventArgs e)
        {
        ...
        {
            frmMailing Mail = new frmMailing();
            FormOpener(Mail);
        }

        private void evaluationToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmEvaluation eval = new frmEvaluation();
            FormOpener(eval);
        }

        private void appraiserToolStripMenuItem_Click(object sender, EventArgs e)
        {

        }

        private void mnuTeste_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
