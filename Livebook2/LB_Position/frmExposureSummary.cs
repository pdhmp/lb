...
namespace LiveBook
{
    public partial class frmPortSummary : LBForm
    {
        ...
        void Carrega_Grid()
        {
            ...
            dgPortSummary.Columns["Prev X uC"].DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
            dgPortSummary.Columns["Prev X uC"].DisplayFormat.FormatString = "P2";
