...
namespace LiveBook
{
    public partial class frmExposure_PL : LBForm
    {
        ...
        void Carrega_Dados()
        {
            ...
            LiveDLL.FormUtils.LoadCombo(this.cmbChoosePortfolio, "Select Id_Portfolio,Port_Name from  VW_Portfolios where Id_Port_Type=2 UNION ALL SELECT '-1', 'All Portfolios'", "Id_Portfolio", "Port_Name", 99);
