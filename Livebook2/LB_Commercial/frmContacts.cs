...
namespace LiveBook
{
    public partial class frmContacts : LBForm
    {
        ...
        private void Carrega_Grid()
        {
            ...
            SQLString = String.Format("SELECT * FROM NESTDB.dbo.FCN_COM_Contact_Summary('{0}')", TradeDate.ToString("yyyyMMdd"));
            ...
            curUtils.SetColumnStyle(dgContacts, 1);
        ...
        private void Update_Contact(int Id_Contact)
        {
            ...
            string ContactName = "";
                ...
                ContactName = curConn.Execute_Query_String("Select Contact_Name FROM NESTDB.dbo.Tb751_Contacts (nolock) WHERE Id_Contact=" + Id_Contact.ToString());
        ...
        {
            dgContacts.SelectAll();
            dgContacts.CopyToClipboard();
        }
