...
namespace LiveBook
{
    public partial class frmContacts_Report : LBForm
    {
        ...
        {
            dtgContReport.DataSource = null;

            string SQLString;
            
            DataTable tablep = new DataTable();

            SQLString = " SELECT A.*, Pedro*NetMngIncome AS Pedro, Felipe*NetMngIncome AS Felipe, Alexander*NetMngIncome AS Alexander, Pedro*NetMngIncome + Felipe*NetMngIncome + Alexander*NetMngIncome AS TotalOfficers FROM " +
                        " ( " +
                        ...
                        " UNION ALL SELECT * FROM NESTDB.dbo.FCN_COM_Contact_Incomes(13, '" + DateTime.Today.ToString("yyyy-MM-dd") + "') " +
                        " UNION ALL SELECT * FROM NESTDB.dbo.FCN_COM_Contact_Incomes(15, '" + DateTime.Today.ToString("yyyy-MM-dd") + "') " +
                        " UNION ALL SELECT * FROM NESTDB.dbo.FCN_COM_Contact_Incomes(19, '" + DateTime.Today.ToString("yyyy-MM-dd") + "') " +
                        " UNION ALL SELECT * FROM NESTDB.dbo.FCN_COM_Contact_Incomes(20, '" + DateTime.Today.ToString("yyyy-MM-dd") + "') " +
                        " UNION ALL SELECT * FROM NESTDB.dbo.FCN_COM_Contact_Incomes(70, '" + DateTime.Today.ToString("yyyy-MM-dd") + "') " +
                        " UNION ALL SELECT * FROM NESTDB.dbo.FCN_COM_Contact_Incomes(37, '" + DateTime.Today.ToString("yyyy-MM-dd") + "') " +
                        " UNION ALL SELECT * FROM NESTDB.dbo.FCN_COM_Contact_Incomes(40, '" + DateTime.Today.ToString("yyyy-MM-dd") + "') " +
                        " UNION ALL SELECT * FROM NESTDB.dbo.FCN_COM_Contact_Incomes(62, '" + DateTime.Today.ToString("yyyy-MM-dd") + "') " +
                        " UNION ALL SELECT * FROM NESTDB.dbo.FCN_COM_Contact_Incomes(50, '" + DateTime.Today.ToString("yyyy-MM-dd") + "') " +
                        ...
                        " 		, SUM(CASE WHEN Id_Officer=38 THEN OfficerPercent ELSE 0 END) AS Alexander " +
                        " 	FROM dbo.Tb754_DistOfficers (nolock) " +
            ...
            using (newNestConn curConn = new newNestConn())
            {
                ...
                dgContReport.Columns["Alexander"].DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
                dgContReport.Columns["Alexander"].DisplayFormat.FormatString = "#,##0.00;(#,##0.00)";
                ...
                curUtils.SetColumnStyle(dgContReport, 1);
                ...
                dgContReport.GroupSummary.Add(SummaryItemType.Sum, "Alexander", dgContReport.Columns["Alexander"], "{0:#,#0.00}");
        ...
        {
            dtgRedemptions.DataSource = null;

            string SQLString;
            
            DataTable tablep = new DataTable();

            SQLString = " SELECT DATEADD(DD, 1 - DAY(redDate), redDate) AS RefMonth, A.*, Pedro*PenaltyValue AS Pedro, Felipe*PenaltyValue AS Felipe, Alexander*PenaltyValue AS Alexander, Pedro*PenaltyValue + Felipe*PenaltyValue + Alexander*PenaltyValue AS TotalOfficers FROM " +
                        " ( " +
                        ...
                        " UNION ALL SELECT * FROM NESTDB.dbo.FCN_COM_Redemptions(40, '2007-12-31', '" + DateTime.Today.ToString("yyyy-MM-dd") + "') " +
                        " UNION ALL SELECT * FROM NESTDB.dbo.FCN_COM_Redemptions(13, '2007-12-31', '" + DateTime.Today.ToString("yyyy-MM-dd") + "') " +
                        " UNION ALL SELECT * FROM NESTDB.dbo.FCN_COM_Redemptions(19, '2007-12-31', '" + DateTime.Today.ToString("yyyy-MM-dd") + "') " +
                        " UNION ALL SELECT * FROM NESTDB.dbo.FCN_COM_Redemptions(70, '2007-12-31', '" + DateTime.Today.ToString("yyyy-MM-dd") + "') " +
                        " UNION ALL SELECT * FROM NESTDB.dbo.FCN_COM_Redemptions(20, '2007-12-31', '" + DateTime.Today.ToString("yyyy-MM-dd") + "') " +
                        " UNION ALL SELECT * FROM NESTDB.dbo.FCN_COM_Redemptions(37, '2007-12-31', '" + DateTime.Today.ToString("yyyy-MM-dd") + "') " +
                        " UNION ALL SELECT * FROM NESTDB.dbo.FCN_COM_Redemptions(62, '2007-12-31', '" + DateTime.Today.ToString("yyyy-MM-dd") + "') " +
                        " UNION ALL SELECT * FROM NESTDB.dbo.FCN_COM_Redemptions(50, '2007-12-31', '" + DateTime.Today.ToString("yyyy-MM-dd") + "') " +
                        " UNION ALL SELECT * FROM NESTDB.dbo.FCN_COM_Redemptions(55, '2007-12-31', '" + DateTime.Today.ToString("yyyy-MM-dd") + "') " +
                        " ) A " +
                        " LEFT JOIN  " +
                        " ( " +
                        "   SELECT Id_Distributor " +
            ...
            using (newNestConn curConn = new newNestConn())
            {
                ...
                dgRedemptions.Columns["Alexander"].DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
                dgRedemptions.Columns["Alexander"].DisplayFormat.FormatString = "#,##0.00;(#,##0.00)";

                dgContReport.Columns["TotalOfficers"].DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
                dgContReport.Columns["TotalOfficers"].DisplayFormat.FormatString = "#,##0.00;(#,##0.00)";

                curUtils.SetColumnStyle(dgRedemptions, 1);
                ...
                dgRedemptions.GroupSummary.Add(SummaryItemType.Sum, "Alexander", dgRedemptions.Columns["Alexander"], "{0:#,#0.00}");
